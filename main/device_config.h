...
static const FamilyConfig FAMILY_SUPRA_TURBO = { .id = SUPRA_TURBO, .name = "SupraTurbo", .asic = ASIC_BM1368, .asic_count = 2, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .swarm_color = "green",    };
