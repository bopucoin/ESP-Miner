...
static const FamilyConfig FAMILY_SUPRA_TURBO = { .id = SUPRA_TURBO, .name = "SupraTurbo", .asic = ASIC_BM1368, .asic_count = 2, .max_power =  40, .power_offset = 10, .nominal_voltage = 12,  .voltage_domains = 1, .swarm_color = "green",    };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "610",  .family = FAMILY_SUPRA_TURBO, .EMC2101 = true,                                                                                 .TPS546 = true,                                                           .power_consumption_target = 22, },
